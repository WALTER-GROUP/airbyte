...
@Disabled
class Db2IBMiJdbcSourceAcceptanceTest extends JdbcSourceAcceptanceTest<Db2IBMiSource, Db2IBMiTestDatabase> {
...
//    INSERT_TABLE_WITHOUT_CURSOR_TYPE_QUERY = "INSERT INTO %s VALUES(true)";
  ...
  static void deleteTablesAndSchema(final Db2IBMiTestDatabase testdb) {
  ...
  @Override
  protected Db2IBMiTestDatabase createTestDatabase() {
    DB_2_CONTAINER.start();
    return new Db2IBMiTestDatabase(DB_2_CONTAINER).initialized();
  }
  ...
  @Override
  protected Db2IBMiSource source() {
    return new Db2IBMiSource();
  }

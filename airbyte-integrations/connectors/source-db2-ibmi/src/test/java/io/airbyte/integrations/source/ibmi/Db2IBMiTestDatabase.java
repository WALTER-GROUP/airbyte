...
import static io.airbyte.integrations.source.ibmi.Db2IBMiJdbcSourceAcceptanceTest.deleteTablesAndSchema;
...
public class Db2IBMiTestDatabase extends
    TestDatabase<Db2Container, Db2IBMiTestDatabase, Db2IBMiTestDatabase.Db2DbConfigBuilder> {

  private final Db2Container container;

  protected Db2IBMiTestDatabase(final Db2Container container) {
    super(container);
  ...
  static public class Db2DbConfigBuilder extends TestDatabase.ConfigBuilder<Db2IBMiTestDatabase, Db2DbConfigBuilder> {

    protected Db2DbConfigBuilder(final Db2IBMiTestDatabase testdb) {
      super(testdb);
    }

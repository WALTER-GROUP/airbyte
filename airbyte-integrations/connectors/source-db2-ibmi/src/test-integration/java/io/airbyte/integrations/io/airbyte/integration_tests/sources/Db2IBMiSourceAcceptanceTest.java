...
import io.airbyte.integrations.source.ibmi.Db2IBMiSource;
...
@Disabled
public class Db2IBMiSourceAcceptanceTest extends SourceAcceptanceTest {
  ...
  private List<String> getActualNamesWithPermission(final JsonNode config) throws Exception {
    final AirbyteCatalog airbyteCatalog = new Db2IBMiSource().discover(config);
